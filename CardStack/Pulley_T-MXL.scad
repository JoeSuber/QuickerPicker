...
teeth = 76;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
profile = 1;		// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm

motor_shaft = 5/16*25.4 + .2;	// NEMA17 motor shaft exact diameter = 5
...
idler_ht = 1.2;		// height of idler flange over pulley, standard = 1.5
